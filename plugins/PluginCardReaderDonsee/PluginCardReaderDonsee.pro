...
INCLUDEPATH += \
    $$PWD/../drivers/ReaderDonsee/include
...
win32:{
    contains(QT_ARCH, i386):{            #86
        CONFIG(release, debug|release):{
            ...
            LIBS += -L$$PWD/../drivers/ReaderDonsee/lib/win/x86/release -lReaderDonsee
        }
        else:CONFIG(debug, debug|release):{
            DESTDIR = $$PWD/../bin/win/x86/debug/plugins
            LIBS += -L$$PWD/../drivers/ReaderDonsee/lib/win/x86/debug -lReaderDonsee
        }
    }
}
