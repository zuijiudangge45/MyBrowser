...
INCLUDEPATH += \
    $$PWD/../drivers/knadc2000A2KDDAA0A0/include
...
win32:{
    contains(QT_ARCH, i386):{            #86
        CONFIG(release, debug|release):{
            ...
            LIBS += -L$$PWD/../drivers/knadc2000A2KDDAA0A0/lib/win/x86/release -lIOServerKNaDA2KDDA0A0
        }
        else:CONFIG(debug, debug|release):{
            DESTDIR = $$PWD/../bin/win/x86/debug/plugins
            LIBS += -L$$PWD/../drivers/knadc2000A2KDDAA0A0/lib/win/x86/debug -lIOServerKNaDA2KDDA0A0
        }
    }
    else:{                              #x64
        CONFIG(release, debug|release):{
            DESTDIR = $$PWD/../bin/win/x64/release/plugins
            LIBS += -L$$PWD/../drivers/knadc2000A2KDDAA0A0/lib/win/x64/release -lIOServerKNaDA2KDDA0A0
        }
        else:CONFIG(debug, debug|release):{
            DESTDIR = $$PWD/../bin/win/x64/debug/plugins
            LIBS += -L$$PWD/../drivers/knadc2000A2KDDAA0A0/lib/win/x64/debug -lIOServerKNaDA2KDDA0A0
...
#            LIBS += -L$$PWD/../bin/linux/x86/debug/ -lPluginCenter
        ...
        CONFIG(release, debug|release):{
            ...
            LIBS += -L$$PWD/../drivers/knadc2000A2KDDAA0A0/lib/linux/x64/release -lIOServerKNaDA2KDDA0A0
        }
        else:CONFIG(debug, debug|release):{
            DESTDIR = $$PWD/../bin/linux/x64/debug/plugins
            LIBS += -L$$PWD/../drivers/knadc2000A2KDDAA0A0/lib/linux/x64/debug -lIOServerKNaDA2KDDA0A0
        }
    }
}
